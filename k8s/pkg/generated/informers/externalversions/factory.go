...
import (
	...
	sys "bytetrade.io/web3os/fs-lib/k8s/pkg/generated/informers/externalversions/sys"
...
func (f *sharedInformerFactory) Sys() sys.Interface {
	return sys.New(f, f.namespace, f.tweakListOptions)
}
